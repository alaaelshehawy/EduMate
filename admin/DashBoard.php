        ...
        <div class="users_info pt-4 bg-dark">
            <div class="search">
                <form action=" " method="get">
                    <input class="input_search me-2" type="search" placeholder="Search with name or email" name="searchs" aria-label="Search">
            ...
            ?>
                ...
                <?php
                    ...
                    if (isset($_REQUEST['searchs'])) {
                        $nameS = $_REQUEST['searchs'];
                $selectc = $con->prepare(" select * from admin where name OR email like '%$nameS%' AND admin_id != 1 ");
                 }else{
