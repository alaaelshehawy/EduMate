        ...
        <div class="users_info pt-4 bg-dark">
            <div class="search">
                <form action=" " method="get">
                    <input class="input_search me-2" type="search" placeholder="Search with massage" name="search" aria-label="Search">
        ...
        <table class="table table-dark table-striped mt-1">
            ...
            <tbody>
                ...
                if (isset($_REQUEST['search'])) {
                    ...
                    $select = $con->prepare(" select * from massages where massage like '%$name%' ");
                } else {
